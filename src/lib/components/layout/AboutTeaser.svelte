...
<script lang="ts">
  ...
  name: "Jesse Chor",
  role: "Co-Founder & CEO",
  image: "/generated/image-a-headshot-of-a-confident-male-founder-i.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
        ...
        text={`"I grew up watching my parents trade time for security—and knew there had to be a better way for essential workers to build stability and be recognized. Tanda isn’t just a product. It’s a promise: real savings, real support, real dignity for teams who keep our world running."`}
    />
